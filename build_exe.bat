...
python -m PyInstaller --noconfirm --clean --windowed --onedir --name YouTubeAIStudio --collect-all customtkinter --collect-all kokoro --collect-all spacy --collect-all soundfile app.py
