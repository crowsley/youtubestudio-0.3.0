...
python -m PyInstaller --noconfirm --clean --windowed --onedir --name YouTubeAIStudio --collect-all customtkinter --collect-all kokoro --collect-all misaki --collect-all phonemizer --collect-all segments --collect-all csvw --collect-all language_tags --collect-all spacy --collect-all soundfile app.py
